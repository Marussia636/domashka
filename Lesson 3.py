...
#  24. Сделать if в котором будет условие:
#  если item_1 меньше comp_item, то вывести в консоль (“Переменная item_1 меньше”, comp_item),
...
#      при target_currency_amount и usd_uah_rate.
